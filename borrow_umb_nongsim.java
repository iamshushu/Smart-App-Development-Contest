...
public class borrow_umb_nongsim extends AppCompatDialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.activity_umb_nongsim, container, false);
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.btn_umb1){
            ...
            ad.setMessage("농심국제관 1에서 빌리시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("농심국제관 2에서 빌리시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("농심국제관 3에서 빌리시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("농심국제관 4에서 빌리시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("농심국제관 5에서 빌리시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("농심국제관 6에서 빌리시겠습니까? ");
