...
public class borrow_umb_2science extends AppCompatDialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.activity_umb_2science, container, false);
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.btn_umb1){
            ...
            ad.setMessage("제2과기대 1에서 빌리시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("제2과기대 2에서 빌리시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("제2과기대 3에서 빌리시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("제2과기대 4에서 빌리시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("제2과기대 5에서 빌리시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("제2과기대 6에서 빌리시겠습니까? ");
