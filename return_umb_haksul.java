...
public class return_umb_haksul extends AppCompatDialogFragment implements View.OnClickListener {

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        //super.onCreateView(inflater, container, savedInstanceState);
        View v = inflater.inflate(R.layout.activity_return_umb_haksul, container, false);
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.btn_umb1){
            ...
            ad.setMessage("학술정보원 1에 반납하시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("학술정보원 2에 반납하시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("학술정보원 3에 반납하시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("학술정보원 4에 반납하시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("학술정보원 5에 반납하시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("학술정보원 6에 반납하시겠습니까? ");
