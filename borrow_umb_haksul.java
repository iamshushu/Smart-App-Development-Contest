...
public class borrow_umb_haksul extends AppCompatDialogFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.activity_umb_haksul, container, false);
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.btn_umb1){
            ...
            ad.setMessage("학술정보원 1에서 빌리시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("학술정보원 2에서 빌리시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("학술정보원 3에서 빌리시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("학술정보원 4에서 빌리시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("학술정보원 5에서 빌리시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("학술정보원 6에서 빌리시겠습니까? ");
