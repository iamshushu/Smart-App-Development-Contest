...
public class return_umb_nongsim extends AppCompatDialogFragment implements View.OnClickListener {

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        //super.onCreateView(inflater, container, savedInstanceState);
        View v = inflater.inflate(R.layout.activity_return_umb_nongsim, container, false);
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.btn_umb1){
            ...
            ad.setMessage("농심국제관 1에 반납하시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("농심국제관 2에 반납하시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("농심국제관 3에 반납하시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("농심국제관 4에 반납하시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("농심국제관 5에 반납하시겠습니까? ");
            ...
            AlertDialog.Builder ad = new AlertDialog.Builder(v.getContext());
            ad.setMessage("농심국제관 6에 반납하시겠습니까? ");
